...
class StaffSignUp extends Component {
    ...
    clickHandler(){
        console.log("Sending post request to admin/sign_up")
        axios.post('/admin/sign_up', {staff:{
    ...
    enterHandler(event){
        if (event.keyCode === 13 && this.state.email && this.state.password && this.state.name){
            this.clickHandler();
        }
    }
    ...
    render(){
        return (
            <div>
                ...
                <p>Company Name: <input name="name" onChange={this.changeHandler} required></input></p>
                ...
                <h3><NavLink to='/staff/sign_up'>Staff? Sign up here</NavLink></h3>
